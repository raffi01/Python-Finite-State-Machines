...
Dodgy I think it's some mix of an adder and an SR flip flop
"""

from transition import Transition, FSM

# The set of states
states = ['Carry Bit is 0', 'Carry Bit is 1']
...
accepting_states = ['Carry Bit is 0', 'Carry Bit is 0']

# The initial state
initial_state = 'Carry Bit is 0'
...
# This sequence represents the sequance:  Set, Reset, Set, do nothing, invalid input
